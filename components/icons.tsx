...
export const ViewBoardsIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 17V7m0 10a2 2 0 01-2 2H5a2 2 0 01-2-2V7a2 2 0 012-2h2a2 2 0 012 2m0 10V7m0 10a2 2 0 002 2h2a2 2 0 002-2V7a2 2 0 00-2-2h-2a2 2 0 00-2 2m8-10v10a2 2 0 002 2h2a2 2 0 002-2V7a2 2 0 00-2-2h-2a2 2 0 00-2 2z" />
    </svg>
);
...
export const SwitchVerticalIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M7 16V4m0 12l-3-3m3 3l3-3m4 3V4m0 12l3-3m-3 3l-3-3" />
    </svg>
);
...
export const MergeIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M7 4v6m0 0l-3-3m3 3l3-3" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M17 4v6m0 0l-3-3m3 3l3-3" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M7 10v4a1 1 0 001 1h8a1 1 0 001-1v-4" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 15v5m0 0l-3-3m3 3l3-3" />
  </svg>
);